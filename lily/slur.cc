...
ADD_INTERFACE (Slur,
               ...
               "@item min-gap-above-staffline\n"
               "Minimum clearance to staffline above slur belly.\n"
               "@item min-gap-below-staffline\n"
               "Minimum clearance to staffline below slur belly.\n"
