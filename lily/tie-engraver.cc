...
protected:
  ...
  /// Why has_autosplit_end is mathod, not a static function (outside class)?
  ...
  for (vsize i = heads_to_tie_.size (); i--;)
    {
      ...
      */
      /// What does it check? If Grob creation was caused by events?
      /// Why do get and check right_ev in every iteration,
      /// instead of getting and checking it before loop?
      if (!right_ev || !left_ev)
        continue;
      ...
      */
      /// Shouldn't it be AND instead of OR (in comment)? Or maybe the code is wrong?
...
Tie_engraver::start_translation_timestep ()
{
  ...
  /// tieMelismaBusy = !heads_to_tie_.empty()
