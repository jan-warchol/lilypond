...
/**
   ...
   TO(NOT?)DO: Remove the dependency on musical info. We should tie on the
   basis of position and duration-log of the heads (not of the events).

   @up: that doesnt seem to make sense.
*/
...
/// to jest prawdopodobnie bez sensu
///*
...
{
    /// Wydaje mi sie, ze ta funkcja ma zla nazwe, jest w zlym miejcu
    /// (powinna byc w Tie), i byc moze w ogole nie powinna byc potrzebna
    /// jako odrebny byt (tzn powinna byc czescia czegos innego)

    /// Warn pewnie uzasadniony, ale chwilowo nie chce, zeby sie pokazywal przy kazdej okazji
...
//    warning (_ ("lonely tie"));
  ...
  /// kto kurcze uzyl to, zamiast Tie::set_head? (pytanie retoryczne, wiem, ze Han-Wen :P)
