  ...
  `(
    ...
    (BalloonTextItem
     . (
        ...
        (text . ,(grob::copy-property-from-event 'text))
        (X-offset . ,(grob::copy-property-from-event 'X-offset))
        (Y-offset . ,(grob::copy-property-from-event 'Y-offset))
        (Y-extent . ,grob::always-Y-extent-from-stencil)
        (meta . ((class . Item)
    ...
    (FootnoteItem
     . (
        ...
        (annotation-line . #t)
        (automatically-numbered . ,(grob::copy-property-from-event 'automatically-numbered))
        (break-visibility . ,(grob::inherit-parent-property
                              X 'break-visibility))
        (footnote . #t)
        (footnote-text . ,(grob::copy-property-from-event 'footnote-text))
        (stencil . ,ly:balloon-interface::print)
        (text . ,(grob::copy-property-from-event 'text))
        (X-extent . #f)
        (Y-extent . #f)
